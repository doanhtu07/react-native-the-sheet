...
- Embedded Stack Navigator: https://www.npmjs.com/package/react-native-embedded-stack-navigator/v/2.0.4
- Universe Portal: https://www.npmjs.com/package/react-native-universe-portal/v/2.0.4
- The Sheet: https://www.npmjs.com/package/react-native-the-sheet/v/2.0.4
...
```bash
npm install react-native-the-sheet@2.0.4
```
