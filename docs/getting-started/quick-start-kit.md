...
```bash
npm install @the-sheet/the-sheet@2.0.25
```
...
- Check out full examples and test cases: [Example Expo App](https://github.com/doanhtu07/react-native-the-sheet/tree/main/apps/example-expo)
