...
/*
  File: node_modules/@react-native/virtualized-lists/types_generated/Lists/VirtualizedListProps.d.ts
  
  Because built-in VirtualizedListProps type is too buggy, we extract the types out and merge them up manually for usage

  How buggy? 
  - When we use built-in VirtualizedListProps in BottomSheetVirtualizedListProps
  - Props "data", "getItem" and "getItemCount" are undefined at call site <BottomSheetVirtualizedList>
  - Even if we can see them in "rest" in bottom-sheet-virtualized-list.tsx
*/
...
export type RequiredVirtualizedListProps = {
  /**
...
export type OptionalVirtualizedListProps = {
...
export type VirtualizedListProps = RequiredVirtualizedListProps &
